...
const Features = () => {
    return (
        <div id='features' style={{ justifyItems: 'center' }} className="grid justify-center grid-cols-1 md:grid-cols-3 gap-14 features-container">
            ...
            <div className=" feature space-y-5 shadow-xl ">
                <figure className='m-auto  w-fit'>
                    <img className='h-16' src={backEndIcon} alt="" />
                </figure>
                <h2 className="text-2xl font-semibold">DB Admin Expert</h2>
                <p>Proficient in database management, I design, maintain and optimize for performance and security. My expertise includes SQL, NoSQL and data modeling.

                </p>
            </div>
            <div className=" feature space-y-5 shadow-xl ">
                <figure className='m-auto  w-fit'>
                    <img className='h-16' src={authIcon} alt="" />
                </figure>
                <h2 className="text-2xl font-semibold">Auth Specialist</h2>
                <p>I excel in implementing robust authentication systems, ensuring secure user access and data protection. My skills include OAuth, JWT, and session management.
                </p>
            </div>
            {/* <div className=" feature space-y-5 shadow-xl ">
                <figure className='m-auto  w-fit'>
